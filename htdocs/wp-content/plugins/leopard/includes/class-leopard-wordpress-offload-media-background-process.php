 ...
 */
abstract class Leopard_Wordpress_Offload_Media_Background_Process extends WP_Background_Process {
	...
	public function schedule_cron_healthcheck( $schedules ) {
		...
		$schedules[ $this->identifier . '_cron_interval' ] = array(
			...
			'display'  => sprintf( __( 'Every %d minutes', 'leopard-wordpress-offload-media' ), $interval ),
		);
